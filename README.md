...
- `name` has the form of `...`, where 
  - the xxx part denotes the name of the benchmark program (e.g. base32), 
  - the xxx part denotes whether it is the POSIX file system or our meta file system. "posix" denotes the POSIX file system, while "uclibc" denotes our meta file system.
